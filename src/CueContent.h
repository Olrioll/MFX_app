...
class CueContent : public QObject
{
    ...
    QSM_READONLY_CSTREF_PROPERTY_WDEFAULT(QString, device, Device,"") //Имя устройства - складвается из типа (Sequence, Pyro ...) и порядкового номера устройства. Не редактируется.
